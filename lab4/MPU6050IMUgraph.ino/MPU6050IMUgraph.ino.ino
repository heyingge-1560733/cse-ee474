...
//    Serial.print("average rate = "); Serial.print(1.0f/deltat, 2); Serial.println(" Hz");
    ...
    tft.setCursor(113, 5); tft.print("yaw");
    tft.setCursor(5, 5); tft.print((int)(yaw));tft.print(" ypr"); 
    if (yaw > 0) {
    tft.drawRect(113, 20, (yaw * 0.5) , 25, ILI9341_YELLOW);
    tft.fillRect(113, 20, (yaw * 0.5) , 25, ILI9341_YELLOW);
    } else if (yaw < 0) {
    tft.drawRect((113 +(yaw * 0.5)), 20, (-yaw * 0.5) , 25, ILI9341_YELLOW);
    tft.fillRect((113 +(yaw * 0.5)), 20, (-yaw * 0.5) , 25, ILI9341_YELLOW);
    }

    tft.setCursor(113, 85); tft.print("pitch");
    tft.setCursor(5, 85); tft.print((int)(pitch));tft.print(" ypr"); 
    if (pitch > 0) {
    tft.drawRect(113, 100, (pitch * 0.5) , 25, ILI9341_BLUE);
    tft.fillRect(113, 100, (pitch * 0.5) , 25, ILI9341_BLUE);
    } else if (pitch < 0) {
    tft.drawRect((113 +(pitch * 0.5)), 100, (-pitch * 0.5) , 25, ILI9341_BLUE);
    tft.fillRect((113 +(pitch * 0.5)), 100, (-pitch * 0.5) , 25, ILI9341_BLUE);
    }

    tft.setCursor(113, 165); tft.print("roll");
    tft.setCursor(5, 165); tft.print((int)(roll));tft.print(" ypr"); 
    if (roll > 0) {
    tft.drawRect(113, 180, (roll * 0.5) , 25, ILI9341_PINK);
    tft.fillRect(113, 180, (roll * 0.5) , 25, ILI9341_PINK);
    } else if (roll < 0) {
    tft.drawRect((113 +(roll * 0.5)), 180, (-roll * 0.5) , 25, ILI9341_PINK);
    tft.fillRect((113 +(roll * 0.5)), 180, (-roll * 0.5) , 25, ILI9341_PINK);
    }
